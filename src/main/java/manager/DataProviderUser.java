...
public class DataProviderUser {
    ...
    public Iterator<Object[]> loginFile() throws IOException {
        List<Object[]> list = new ArrayList<>();
        BufferedReader reader = new BufferedReader(new FileReader(new File("src/test/resources/testData")));
    ...
    public Iterator<Object[]> loginModels(){
        List<Object[]> list = new ArrayList<>();
        list.add(new Object[]{new User().setEmail("dasha@gmail.com").setPassword("Ashtanga8!")});
        list.add(new Object[]{new User().setEmail("dasha@gmail.com").setPassword("Ashtanga8!")});
