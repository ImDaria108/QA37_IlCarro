...
public class HelperCar extends HelperBase{
    ...
    public void searchCurrentMounth(String city, String dateFrom, String dateTo) {
        pause(1000);
        typeCity(city);
    ...
    private void clickNextMounthBtn(int diffMonth) {
    ...
    public void searchInvalidPeriod(String city, String dateFrom, String dateTo) {
        pause(1000);
        typeCity(city);
        clearTextBox(By.id("dates"));
